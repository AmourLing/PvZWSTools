...
public class WebSocketClient
{
    ...
    private void Ws_OnError(object sender, WebSocketSharp.NetCore.ErrorEventArgs e)
    {
    ...
    /// <summary>
    /// 通知连接状态变化。<see cref="onConnectionStatusChanged"/> 回调由调用方负责切回 UI 线程
    /// （MainActivity 传入的回调内部已做 RunOnUiThread），因此这里无需再次调度。
    /// </summary>
